<?php
/* Smarty version 3.1.29, created on 2016-05-27 17:30:10
  from "/var/www/beta/template/tpl/admin/member-list.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_574813a2a0dd58_83984873',
  'file_dependency' => 
  array (
    '9b8970274f6178f9110f16005c7c8bf4412dfc7f' => 
    array (
      0 => '/var/www/beta/template/tpl/admin/member-list.html',
      1 => 1464341402,
      2 => 'file',
    ),
  ),
...
function content_574813a2a0dd58_83984873 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
			<tr>
				<td><?php echo $_smarty_tpl->tpl_vars['row']->value['Member'];?>
</td>
				...
				<td><?php echo $_smarty_tpl->tpl_vars['row']->value['Card'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['row']->value['CardType'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['row']->value['AvailablePoint'];?>
</td>
				<th><form class="edit_dad" action="/edit.html" method="post">
					<input type="hidden" name="ID" value="{$row.ID}" />
					<input class="edit" type="submit" value="编辑" />
				</form></th>
			</tr>
			<?php
